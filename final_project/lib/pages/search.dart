...
class _SearchPageState extends State<SearchPage> {
  ...
  List<Map<String, dynamic>> getFilteredChefs() {
    ...
    // Apply sorting
    if (_sortBy == 'Price') {
      filteredChefs.sort((a, b) => a['price'].compareTo(b['price']));
    } else if (_sortBy == 'Rating') {
      filteredChefs.sort((a, b) => b['rating'].compareTo(a['rating']));
    } else if (_sortBy == 'Order Count') {
      filteredChefs.sort((a, b) => b['orderCount'].compareTo(a['orderCount']));
    }
            ...
            Row(
              ...
              children: [
                ...
                DropdownButton<String>(
                  value: _sortBy,
                  items: ['Price', 'Rating', 'Order Count'].map((String value) {
